...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "convergence-signal" = rec {
        crateName = "convergence-signal";
        version = "0.1.0";
        edition = "2021";
        crateBin = [
          {
            name = "convergence-signal";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
      ...
      "kube" = rec {
        ...
        resolvedDefaultFeatures = [ "client" "config" "kube-client" "kube-runtime" "runtime" "rustls-tls" ];
      };
      "kube-client" = rec {
      ...
      "tower" = rec {
        ...
        resolvedDefaultFeatures = [ "buffer" "filter" "futures-core" "futures-util" "log" "make" "pin-project-lite" "sync_wrapper" "tokio" "tokio-util" "tracing" "util" ];
      };
      "tower-http" = rec {
